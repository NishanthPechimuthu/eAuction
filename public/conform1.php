...
$farmer_id = $auction["auctionCreatedBy"];
$vendor_id = getHighestBidderId($auction_id);
    ...
    if ($user_id === $vendor_id) {
        if ($action === 'proceed') {
            ...
            echo "<script>
                    document.addEventListener('DOMContentLoaded', function() {
                        Swal.fire({
                            title: 'Success!',
                            text: 'Transaction payment settled successfully.',
                            icon: 'success',
            ...
            if ($image_count === 0 || $image_count > 3) {
                ...
                echo "<script>
                        document.addEventListener('DOMContentLoaded', function() {
                            Swal.fire({
                                title: 'Error',
                                text: 'Please upload 1 to 3 proof images.',
                                icon: 'error',
        ...
        echo "<script>
                document.addEventListener('DOMContentLoaded', function() {
                    Swal.fire({
                        title: 'Error',
                        text: 'You are not authorized to confirm this transaction.',
                        icon: 'error',
                        confirmButtonColor: '#dc3545'
                    });
                });
        ...
        document.addEventListener('DOMContentLoaded', function() {
            function confirmProceed() {
                Swal.fire({
                    ...
                    text: 'Have you received the product from the farmer and is the quality satisfactory?',
                    icon: 'question',
            ...
            function confirmRefund() {
                ...
                if (files.length === 0 || files.length > 3) {
                    ...
                    Swal.fire({
                        ...
                        text: 'Are you sure the product quality is unsatisfactory? This will initiate a refund request for admin review.',
                        icon: 'warning',
                        showCancelButton: true,
                        confirmButtonText: 'Yes',
                        cancelButtonText: 'No',
